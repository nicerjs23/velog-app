    ...
    public void run(String... args) {
        if (boardRepository.count() == 0) {
            ...
            boardRepository.save(new Board(
                    ...
                    "/img2.png", "작성자2", "/profile2.png", 65));

            boardRepository.save(new Board(
                    "과제 화이팅!",
                    "api 잘 불려와지나요?",
                    "/img3.png", "작성자3", "/profile3.png", 18));

            boardRepository.save(new Board(
                    "심바톤도 고생하셨습니다.",
                    "다들 수고많으셨어요! 중앙해커톤도 화이팅!! 리액트 재밌어요 ",
                    "/img4.png", "작성자4", "/profile4.png", 0));
